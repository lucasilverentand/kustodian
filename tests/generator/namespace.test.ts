...
import {
  ...
  is_system_namespace,
} from '../../src/generator/namespace.js';
import type { ResolvedTemplateType } from '../../src/generator/types.js';
...
describe('Namespace Module', () => {
  ...
  describe('Dynamic System Namespaces', () => {
    it('get_system_namespaces should include custom flux namespace', () => {
      // Act
      const { get_system_namespaces } = require('../../src/generator/namespace.js');
